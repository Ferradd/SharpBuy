...
async function redeemNewestGmailKey() {
  const key = 'PREMIER3HNGJHLGPFXZOF452NRC';
  console.log(`Redeeming newest Gmail key ${key}...`);
  ...
  if (token) {
    ...
    console.log('Saved to database and Desktop/steam.txt!');
  }
}

redeemNewestGmailKey();
